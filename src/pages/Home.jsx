    ...
    <>
      ...
      <div className="tools-grid">
        ...
        <Link className="tool-card" to="/carga-retenciones">
          <Receipt className="tool-icon-lg" color="var(--lav-ink)" strokeWidth={1.75} />
          <div className="tool-name">Carga de retenciones</div>
          <div className="tool-desc">Registro temporal de retenciones, mientras se termina la app definitiva.</div>
          <div className="tool-status sheets">Google Sheets</div>
        </Link>
      </div>
